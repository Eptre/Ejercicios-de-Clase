...
Grupo 2
Visual Studio 2017
Práctica 12 Clase "Animación de carrito"
*/
...
void animacion()
{
	...
	if(circuito)
	{
		...
		if(recorrido3)
		{
			rotKit = 210; // La rotación necesaria para simular el giro del carro en la dirección correcta
			movKitZ = movKitZ - 7; // La velocidad que toma sobre el eje Z
			movKitX = movKitX - 7; // La velocidad que toma sobre el eje X
	

			if(movKitZ < 40) // Condición hasta llegar a la unidad 40 del eje Z para cambiar de estado.
			{
				recorrido3 = false; // Se desactiva el recorrido actual (3)
				recorrido5 = true; // Se activa el recorrido siguiente (5)
			}
		}

		if (recorrido1 && reversa) {
		...
		if (recorrido3 && reversa) {

			rotKit = 30; // La rotación necesaria para simular el giro del carro en la dirección correcta
			movKitZ = movKitZ + 7; // La velocidad que toma sobre el eje Z
			movKitX = movKitX + 7; // La velocidad que toma sobre el eje X


			if (movKitX < 40) // Condición hasta llegar a la unidad 40 del eje Z para cambiar de estado.
			{
				recorrido3 = false; // Se desactiva el recorrido actual (3)
				recorrido2 = true; // Se activa el recorrido siguiente (5)
			}
		}

		if (recorrido2 && reversa) {
			rotKit = 270;
			movKitX = movKitX - 7;
